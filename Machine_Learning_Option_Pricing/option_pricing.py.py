...
for model in models:
    ...
    pred = predictive_performance[predictive_performance["Model"]==model]["Predicted"]
    actual = predictive_performance[predictive_performance["Model"]==model]["BlackScholesPrice"]
